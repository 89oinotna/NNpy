...
params = {
    'layer_sizes': [(20, 40, 20, 2), (40, 40, 2)],
...
if __name__ == '__main__':
    ...
    #network = nn.NeuralNetwork.init([4, 2], 10, act_hidden='relu', act_out='sigmoid', w_init='monk', loss='mse',
    #                                metric='mee', optimizer=optimizer, weight_regularizer=wreg, epochs=400, minibatch_size=32)
    #(tr_metric, tr_loss), (vl_metric, vl_loss) = network.fit(train_data, train_labels, valid_data, valid_labels)
#vis.plot(tr_loss, vl_loss, tr_metric, vl_metric)
# x=np.array([[2,1],[2,1]])
